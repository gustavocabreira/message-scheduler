    ...
    <SidebarMenuItem>
      <DropdownMenu>
        <DropdownMenuTrigger as-child>
          ...
          >
            <template v-if="activeTeam">
              <div
                class="flex aspect-square size-8 items-center justify-center rounded-lg bg-primary text-sidebar-accent text-xs font-semibold shrink-0"
              >
        ...
        >
          ...
          >
            <div
              class="flex size-6 items-center justify-center rounded-sm border bg-sidebar-primary text-sidebar-primary-foreground text-xs font-semibold shrink-0"
            >
            ...
            <div class="grid flex-1 text-left text-sm leading-tight">
              ...
              <span v-if="team.role" class="truncate text-xs text-muted-foreground capitalize">{{
                team.role
              }}</span>
            </div>
          </DropdownMenuItem>
